...
const Topnav = () => {
    ...
    return (
        <>
            <div class=" cursor-default bg-gray-800 flex items-center justify-end w-auto border border-black" >
                <button class="py-4 px-1 relative border-2 border-transparent text-gray-800 rounded-full hover:text-gray-400 focus:outline-none focus:text-gray-500 transition duration-150 ease-in-out border-red-500 mr-4" aria-label="Cart">
                ...
                <a class="flex items-center justify-end w-fit h-16 mt-auto  hover:bg-gray-700 text-white "
                    href="#" >
