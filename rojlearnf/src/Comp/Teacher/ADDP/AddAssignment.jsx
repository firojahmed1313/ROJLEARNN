...
const addAsseFunc = async (obj) => {
    const token = Cookies.get("ROJLEARN");
    const response = await axios.post(`${burl}/assignment/create`, obj, {
        headers: {
            ...
            <AlertDialog>
                <div className='w-full mt-8'>
                    <AlertDialogTrigger asChild>
                        <button className="flex gap-3 cursor-pointer text-white font-semibold bg-gradient-to-r from-gray-800 to-black px-7 py-3 rounded-md border border-gray-600 hover:scale-105 duration-200 hover:text-gray-500 hover:border-gray-800 hover:from-black hover:to-gray-900 ml-auto mr-4">Add Assignment</button>
                    </AlertDialogTrigger>
                </div>
                            ...
                            <AlertDialogHeader>
                                <div className="bg-white h-[60dvh] rounded-lg  m-2">
                                    <div className="flex items-start justify-between p-5 border-b rounded-t">
                                        <h3 className="text-xl font-semibold">Add Assignment</h3>
