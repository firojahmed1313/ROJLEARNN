            ...
            <AlertDialog>
                <div className="w-full mt-8">
                    <AlertDialogTrigger asChild>
                        <button className="flex gap-3 cursor-pointer text-white font-semibold bg-gradient-to-r from-gray-800 to-black px-7 py-3 rounded-md border border-gray-600 hover:scale-105 duration-200 hover:text-gray-500 hover:border-gray-800 hover:from-black hover:to-gray-900 ml-auto mr-4">
                            Add Exam
                        </button>
                    </AlertDialogTrigger>
                </div>
