        ...
        (isloading) ?
          ...
          <div className="items-center flex flex-wrap my-4">
            <div className="hidden lg:block w-full md:w-4/12 ml-auto mr-auto px-4">
              <img alt="..." className="max-w-full rounded-lg shadow-lg" src="https://images.unsplash.com/photo-1494173853739-c21f58b16055?q=80&w=1965&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
            </div>
            <div className="w-[96%] lg:w-5/12 ml-auto mr-auto px-4 mx-auto">
              <div className="md:pr-12">
                ...
                <h2 className="text-sky-600 text-lg font-semibold">{examDetails?.questiontype?.toUpperCase()}</h2>
                ...
                <ul className="list-none mt-6">
                  ...
                  <li className="py-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-blueGray-500 font-semibold"> Total Marks : {examDetails?.totalmarks}</h4>
                      </div>
                    </div>
                  </li>
                  <li className="py-2">
                    <div className="flex items-center">
                      <div>
                        <span className="text-xs font-semibold inline-block py-2 px-2 uppercase rounded-full text-pink-600 bg-sky-200 mr-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 className="text-blueGray-500 font-semibold"> Total Questions : {examDetails?.totalquestions}</h4>
                      </div>
                    </div>
                  </li>
                </ul>
