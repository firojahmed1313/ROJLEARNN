...
import AETloader from "./loder/AETloader";
...
const AETST = ({ id, type, role }) => {
    ...
    if (type == "Exam") {
        ...
        isLoading = useSelector((state) => state.getExamByCourse.isLoading);
    } else if (type == "Task") {
        data = useSelector((state) => state.getTaskByCourse.taskbyid);
        isLoading = useSelector((state) => state.getTaskByCourse.isLoading);
