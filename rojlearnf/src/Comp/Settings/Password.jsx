...
const Password = ({ user }) => {
    ...
    return (
        <>
                ...
                <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
                    <label htmlFor="login-password">
                        ...
                        <div className="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-blue-600">
                            <input type="text" id="login-password" className="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="***********" />
                        </div>
                    </label>
                    <label htmlFor="login-password">
                    ...
                    <label htmlFor="login-password">
                        <span className="text-sm text-gray-500">ReEnter New Password</span>
                        <div className="relative flex overflow-hidden rounded-md border-2 transition focus-within:border-blue-600">
                            <input type="text" id="login-password" className="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="***********" />
                        </div>
                    </label>
            ...
            <div className="mb-10">
                <p className="py-2 text-xl font-semibold">Deactive Your Account</p>
                <p className="inline-flex items-center rounded-full bg-rose-100 px-4 py-1 text-yellow-500">
                ...
                <p className="mt-2">Make sure you have taken backup of your account in case you ever need to get access to your data. We will completely wipe your data. There is no way to access your account after this action.</p>
                <button className="ml-auto text-sm font-semibold text-yellow-500 underline decoration-2" onClick={handelDeactive}>Continue with deactivation</button>
            </div>
            {/* <div >
                <Deactivate />
            </div> */}
            ...
            <div className="mb-10">
                ...
                <p className="mt-2">Make sure you have taken backup of your account in case you ever need to get access to your data. We will completely wipe your data. There is no way to access your account after this action.</p>
                <button className="ml-auto text-sm font-semibold text-rose-600 underline decoration-2" onClick={handelDelete}>Continue with deletion</button>
            </div>
        {/* <div >
            <Delete />
        </div> */}
