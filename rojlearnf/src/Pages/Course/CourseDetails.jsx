                            ...
                            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                                ...
                                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                    ...
                                    <div className="flex mt-4">
                                        ...
                                        <button className="flex ml-auto  text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">{course.data.is_published ? "Buy Now" : "Comming Soon"}</button>
                                        <button className="rounded-full w-10 h-10 bg-indigo-500 hover:bg-indigo-600 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                                            {/* <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
