                    ...
                    <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover">
                        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                                ...
                                <div className="p-4 md:p-12 text-center lg:text-left ">
                                    ...
                                    <p className="pt-4 text-base font-bold flex items-center justify-start">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" className="h-8 fill-current text-green-700 pr-4">
                                            <path fill="#049f38" d="M32.33 6a2 2 0 0 0-.41 0h-28a2 2 0 0 0-.53.08l14.45 14.39Z" className="clr-i-solid clr-i-solid-path-1" />
                                            <path fill="#049f38" d="m33.81 7.39l-14.56 14.5a2 2 0 0 1-2.82 0L2 7.5a2 2 0 0 0-.07.5v20a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2V8a2 2 0 0 0-.12-.61M5.3 28H3.91v-1.43l7.27-7.21l1.41 1.41Zm26.61 0h-1.4l-7.29-7.23l1.41-1.41l7.27 7.21Z" className="clr-i-solid clr-i-solid-path-2" />
                                        </svg> {user?.email}
                                    </p>
                                    <p className="pt-4 text-base font-bold flex items-center justify-start">
                                    ...
                                    <div className="pt-12 pb-8">
                                        <Link to={"/settings"} className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                                            Settings
                                        </Link>
                                    </div>
                            ...
                            <div className="w-full lg:w-2/5">
                                <img src={user?.profile_picture_url} className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />

                            </div>


                            {/* <div className="absolute top-16 right-0 h-12 w-18 p-4">
